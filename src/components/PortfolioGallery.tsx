...
import { Instagram, Heart, Camera, ExternalLink, Sparkles } from "lucide-react";
...
export default function PortfolioGallery() {
  ...
  return (
    <section id="galeri" className="relative py-16 sm:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto z-10">
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6">
        <div>
          ...
          <p className="text-zinc-400 text-xs sm:text-base max-w-2xl mt-2">
            Dokumentasi langsung dari portfolio Instagram{" "}
            <a
              href="https://www.instagram.com/bachtiar._.photography.id/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-racing-cyan hover:underline font-semibold"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-racing-neon hover:underline font-semibold"
            >
              @sewa.camera.pamulang
            </a>
            .
          </p>
        </div>
        ...
        <div className="flex flex-wrap gap-2.5">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-cyan-950/80 to-blue-950/80 border border-cyan-500/40 text-xs font-mono text-cyan-300 hover:text-white hover:border-cyan-400 hover:scale-105 transition-all shadow-lg shadow-cyan-500/10"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-purple-950/80 to-pink-950/80 border border-pink-500/40 text-xs font-mono text-pink-300 hover:text-white hover:border-pink-400 hover:scale-105 transition-all shadow-lg shadow-pink-500/10"
          >
          ...
          {filteredItems.map((item) => (
            ...
            >
              ...
              <div className="absolute top-4 left-4 right-4 flex items-center justify-between z-10">
                <span className="px-2.5 py-1 rounded-lg text-[10px] font-mono uppercase tracking-wider bg-black/75 backdrop-blur-md text-racing-cyan border border-white/10 font-bold">
                  {item.category}
                </span>

                <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-black/75 backdrop-blur-md text-[11px] font-mono text-zinc-300 border border-white/10">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5 z-10 space-y-1.5 transform transition-transform">
                ...
                <div className="pt-2 flex items-center justify-between border-t border-white/10">
                  ...
                  <a
                    href={`https://www.instagram.com/${item.instaUser.replace("@", "")}/`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-1 text-[11px] font-mono text-cyan-400 hover:text-white transition-colors"
                  >
                    <span>Buka Feed Instagram</span>
